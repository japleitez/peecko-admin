...
describe('Video Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call VideoCategory query and add missing value', () => {
      ...
      const videoCategory: IVideoCategory = { id: 14069 };
      video.videoCategory = videoCategory;

      const videoCategoryCollection: IVideoCategory[] = [{ id: 12061 }];
    ...
    it('Should call Coach query and add missing value', () => {
      const video: IVideo = { id: 456 };
      const coach: ICoach = { id: 23253 };
      video.coach = coach;

      const coachCollection: ICoach[] = [{ id: 31107 }];
    ...
    it('Should update editForm', () => {
      const video: IVideo = { id: 456 };
      const videoCategory: IVideoCategory = { id: 4577 };
      video.videoCategory = videoCategory;
      const coach: ICoach = { id: 7564 };
      video.coach = coach;
