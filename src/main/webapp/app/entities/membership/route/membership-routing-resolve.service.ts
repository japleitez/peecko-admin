...
export class MembershipRoutingResolveService implements Resolve<IMembership | null> {
  constructor(protected service: MembershipService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IMembership | null | never> {
