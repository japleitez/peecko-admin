...
describe('Membership Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'membership', component: MembershipComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.memberships?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
