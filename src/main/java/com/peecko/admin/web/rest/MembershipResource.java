...
import com.peecko.admin.service.MembershipService;
...
/**
 * REST controller for managing {@link com.peecko.admin.domain.Membership}.
 */
@RestController
@RequestMapping("/api")
public class MembershipResource {
    ...
    public ResponseEntity<List<MembershipDTO>> getAllMemberships(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
