...
public class CoachResource {
    ...
    public ResponseEntity<CoachDTO> updateCoach(
        ...
        CoachDTO result = coachService.update(coachDTO);
        return ResponseEntity
            .ok()
     ...
     */
    @GetMapping("/coaches")
    public ResponseEntity<List<CoachDTO>> getAllCoaches(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
