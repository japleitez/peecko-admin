...
class CompanyResourceIT {
    ...
    private static final Country DEFAULT_COUNTRY = Country.LU;
    private static final Country UPDATED_COUNTRY = Country.FR;

    private static final ClientState DEFAULT_STATE = ClientState.CREATED;
    private static final ClientState UPDATED_STATE = ClientState.TRIAL;
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).country(UPDATED_COUNTRY).license(UPDATED_LICENSE);
