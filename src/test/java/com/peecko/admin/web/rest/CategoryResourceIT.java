...
import com.peecko.admin.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    private static final CategoryType DEFAULT_TYPE = CategoryType.FITNESS;
    private static final CategoryType UPDATED_TYPE = CategoryType.WELLNESS;
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.code(UPDATED_CODE).type(UPDATED_TYPE).state(UPDATED_STATE).name(UPDATED_NAME).label(UPDATED_LABEL);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).type(UPDATED_TYPE).state(UPDATED_STATE).name(UPDATED_NAME).label(UPDATED_LABEL);
