...
import com.peecko.admin.service.mapper.PersonMapper;
...
class PersonResourceIT {
    ...
    void putExistingPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).surname(UPDATED_SURNAME).email(UPDATED_EMAIL).password(UPDATED_PASSWORD).license(UPDATED_LICENSE);
