...
class InvoiceItemResourceIT {
    ...
    void createInvoiceItem() throws Exception {
        ...
        assertThat(testInvoiceItem.getQuatity()).isEqualTo(DEFAULT_QUATITY);
    ...
    @Test
    @Transactional
    void checkQuatityIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoiceItemRepository.findAll().size();
        // set the field null
        invoiceItem.setQuatity(null);
    ...
    void putExistingInvoiceItem() throws Exception {
        ...
        assertThat(testInvoiceItem.getQuatity()).isEqualTo(UPDATED_QUATITY);
