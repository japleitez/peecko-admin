...
public class ApsOrderTestSamples {
    ...
    public static ApsOrder getApsOrderSample1() {
        return new ApsOrder().id(1L).contract("contract1").period(1).license("license1").numberOfUsers(1).invoiceNumber("invoiceNumber1");
    }

    public static ApsOrder getApsOrderSample2() {
        return new ApsOrder().id(2L).contract("contract2").period(2).license("license2").numberOfUsers(2).invoiceNumber("invoiceNumber2");
    }
